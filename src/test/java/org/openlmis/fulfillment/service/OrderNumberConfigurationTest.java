...
public class OrderNumberConfigurationTest {
  ...
  public void shouldThrowExceptionWhenPrefixIsNotAlphanumeric() {
    final String noAlphanumericString = "..dsa2,";

    OrderNumberConfiguration orderNumberConfiguration =
        new OrderNumberConfiguration(noAlphanumericString, true, false, false);

    orderNumberConfiguration.generateOrderNumber(requisition, program);
  }

  @Test(expected = OrderNumberException.class)
  public void shouldThrowExceptionWhenPrefixHasMoreThan8Characters() {
